...
async def start_extraction(request: Request, batch_id: str):
    ...
    _extraction_progress[batch_id] = {"progress": 0, "done": False, "error": None, "result": None}
...
async def extraction_progress(request: Request, batch_id: str):
    ...
    prog = _extraction_progress.get(batch_id, {"progress": 0, "done": False, "error": None, "result": None})
